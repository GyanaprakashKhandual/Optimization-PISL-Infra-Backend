...
export const options = {
    stages: [
        { duration: '30s', target: 100, name: 'GET /recentActivity' },
    ],
};
...
const res = http.get(`${BASE_URL}/recentActivity`, { headers });

check(res, {
    'GET /recentActivity Status 200-299': (r) => r.status >= 200 && r.status < 300,
});
}
